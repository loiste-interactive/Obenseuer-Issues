...
* Fixed blurry text (issue [#5516](https://github.com/loiste-interactive/Obenseuer-Issues/issues/5516))
...
* Fixed construction material box ownership (issue [#5523](https://github.com/loiste-interactive/Obenseuer-Issues/issues/5523))
...
* Fixed not being able to clean up debris
...
* Fixed not being able to talk with Ruth
...
* Fixed Lätty not actually taking the pizza.
...
* Fixed some NPCs missing animations (issue [#5447](https://github.com/loiste-interactive/Obenseuer-Issues/issues/5447))
...
* Fixed the True Welho quest issues (issue [#5200](https://github.com/loiste-interactive/Obenseuer-Issues/issues/5200))
...
* Fixed the passport photo event background audio not playing
...
* Fixed huge workshop lights (issue [#5116](https://github.com/loiste-interactive/Obenseuer-Issues/issues/5116))
...
* Fixed despawning blue duck head (issue [#4830](https://github.com/loiste-interactive/Obenseuer-Issues/issues/4830))
...
* Fixed not being able to take a loan

## Items

* Added furniture flatpack
...
* Fixed Anna requiring you to return paper trash (issue [#442](https://github.com/loiste-interactive/Obenseuer-Issues/issues/4452))
...
* Fixed two Crazy Neighbors spawning sometimes (issue [#4348](https://github.com/loiste-interactive/Obenseuer-Issues/issues/4348))
...
* Fixed Aleksi Kivi spawn bug (issue [#4319](https://github.com/loiste-interactive/Obenseuer-Issues/issues/4319)) (Playtest)
...
* Fixed Commercial Fridge only allowing bottles (issue [#3561](https://github.com/loiste-interactive/Obenseuer-Issues/issues/3561))
...
* Fixed Crazy Neighbor being in saves where shouldn't be (issue [#4156](https://github.com/loiste-interactive/Obenseuer-Issues/issues/4156)) (Playtest)
...
* Added support for item translations
...
* Improved IV basnement lighting (issue [#4089](https://github.com/loiste-interactive/Obenseuer-Issues/issues/4089))
...
* Fixed the 'Getting Started' task not correctly counting the number of renovations if the player began renovations before receiving the first renovation objective from Malone (issue [#3957](https://github.com/loiste-interactive/Obenseuer-Issues/issues/3957))
...
* Fixed performance issues (issue [#3963](https://github.com/loiste-interactive/Obenseuer-Issues/issues/3963)) (Playtest)
...
* Fixed pause menu Post FX setting arrows (issue [#3946](https://github.com/loiste-interactive/Obenseuer-Issues/issues/3946))
...
* Fixed courtyard upgrade requirements (issue [#3919](https://github.com/loiste-interactive/Obenseuer-Issues/issues/3919))
...
* Added Wizard Plush
* Added Parcel Notification Card
...
* Fixed 2nd tier balcony z-fighting issue (issue [#3759](https://github.com/loiste-interactive/Obenseuer-Issues/issues/3759))
...
* Fixed collision issues on makeshift yard upgrade stairs (issue [#3464](https://github.com/loiste-interactive/Obenseuer-Issues/issues/3464))
...
* Fixed some states not being saved (storages/roadblock) (issue [#3430](https://github.com/loiste-interactive/Obenseuer-Issues/issues/3430), [#3443](https://github.com/loiste-interactive/Obenseuer-Issues/issues/3443))
