...
* Fixed items not respawning on some old saves
* Fixed being unable to make calls (issue [#4338](https://github.com/loiste-interactive/Obenseuer-Issues/issues/4338))
