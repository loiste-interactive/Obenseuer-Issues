...
* Player can now claim to be innocent (without landing to prison) if already sorted out their crimes (issue [#3879](https://github.com/loiste-interactive/Obenseuer-Issues/issues/3879))
